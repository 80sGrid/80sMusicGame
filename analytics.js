// ═══════════════════════════════════════════════════════════════════════════════
// 80sMusicGame.com — Google Analytics 4 In-Depth Tracking
...
function getQuizUrl(quizNum) {
  if (quizNum === 1) return 'https://80smusicgame.com/';
  if (quizNum === 'answers') return 'https://80smusicgame.com/answers.html';
  return 'https://80smusicgame.com/quiz' + quizNum + '.html';
}
...
(function() {
  ...
  trackEvent('page_view_enhanced', {
    ...
    landing_page: !document.referrer || !document.referrer.includes('80smusicgame')
  });
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('a[href^="http"]').forEach(function(link) {
      if (!link.href.includes('80smusicgame')) {
        link.addEventListener('click', function() {
          var url = this.href;
    ...
    if (typeof window.shareScore === 'function') {
      window.shareScore = function() {
        ...
        if (resultsVisible && scoreMatch) {
          shareText = 'I scored ' + scoreMatch[1] + '/' + scoreMatch[2] + ' on Len\'s 80sMusicGame Quiz ' + quizNum + '! Can you beat me? ' + shareUrl;
        } else {
          shareText = 'Test your 80s music knowledge on Len\'s 80sMusicGame! ' + shareUrl;
        }
        ...
        if (navigator.share) {
          navigator.share({ title: "Len's 80sMusicGame.com Music Edition", text: shareText }).catch(function() {});
        } else {
    ...
    (function() {
      ...
      if (utm_source === 'share') {
        ...
        else if (ref.includes('80smusicgame')) source = 'internal';
